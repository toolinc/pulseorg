...
/**
 * Specifies additional attributes for reference mapping objects.
 *
...
public class ReferenceDetail extends RangeDateDomainObject {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "idReferenceDetail")
    ...
    @JoinColumn(name = "idReference", referencedColumnName = "idReference",
            foreignKey = @ForeignKey(name = "ReferenceDetail_Reference_FK"))
    @ManyToOne(fetch = FetchType.LAZY)
    private Reference reference;

    @JoinColumn(name = "idParentRuleDetail", referencedColumnName = "idRuleDetail",
            foreignKey = @ForeignKey(name = "ReferenceDetail_ReferenceDetail_FK"))
    @ManyToOne(fetch = FetchType.LAZY)
